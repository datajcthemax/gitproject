...
X_test_scaled = test_data[['Exercise_Duration','Body_Temperature(F)','BPM','Height(Feet)','Weight(lb)','Age','Gender_F','Gender_M','Weight_Status_Normal Weight','Weight_Status_Obese','Weight_Status_Overweight']]
