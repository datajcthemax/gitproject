...
X_train = train_data[['Exercise_Duration', 'Body_Temperature(F)', 'BPM', 'Height(Feet)', 'Weight(lb)', 'Age',
                      'Gender_F', 'Gender_M', 'Weight_Status_Normal Weight', 'Weight_Status_Obese', 'Weight_Status_Overweight']]
X_test = test_data[['Exercise_Duration', 'Body_Temperature(F)', 'BPM', 'Height(Feet)', 'Weight(lb)', 'Age',
                    'Gender_F', 'Gender_M', 'Weight_Status_Normal Weight', 'Weight_Status_Obese', 'Weight_Status_Overweight']]
...
X_train_scaled = train_data[['Exercise_Duration', 'Body_Temperature(F)', 'BPM', 'Height(Feet)', 'Weight(lb)', 'Age',
                             'Gender_F', 'Gender_M', 'Weight_Status_Normal Weight', 'Weight_Status_Obese', 'Weight_Status_Overweight']]
X_test_scaled = test_data[['Exercise_Duration', 'Body_Temperature(F)', 'BPM', 'Height(Feet)', 'Weight(lb)', 'Age',
                           'Gender_F', 'Gender_M', 'Weight_Status_Normal Weight', 'Weight_Status_Obese', 'Weight_Status_Overweight']]
...
X_test_scaled.to_csv('2_test.csv', index=False)
"""
